package com.felix.bookmark_app.util;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    private boolean checkClaims(String token){
        ...
        if (!"bookmark-app-backend".equals(claims.getIssuer())) {
        ...
        if (claims.get("username") == null || claims.get("role") == null) {
            log.error("Token claims are invalid: does not contain username and role");
            return false;
        }

        log.info("Token is valid. Username: {}, Role: {}",
